                        ...
                        <div class="row">
                            <div class="col-12 col-md-6 col-lg-6 mx-auto">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="<?php echo base_url('user/update/'. $data['id_user']) ?>" method="post">
                                            <div class="form-group">
                                                <label>Nama Lengkap</label>
                                                <input type="text" name="nama" value="<?php echo $data['nama_lengkap'] ?>" class="form-control" autofocus required autocomplete="off">
                                            </div>
                                            <div class="form-group">
