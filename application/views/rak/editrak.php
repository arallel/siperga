                    ...
                    <div class="row">
                        <div class="col-12 col-lg-9 col-md-5 mx-auto">
                            <div class="card">
                                ...
                                <div class="row">
                                        <div class="col-12">
                                <form action="<?php echo base_url('rak/update/'.$data['id_rak']) ?>" method="post">
                                    <div class="form-group">
                                        <label>Nama Rak</label>
                                        <input type="text" name="nama_rak" value="<?php echo $data['nama_rak'] ?>" class="form-control" required autofocus>
                                    </div>
                                    </div>
